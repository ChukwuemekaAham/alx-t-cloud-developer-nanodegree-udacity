...
Postman is a useful tool to issue and save requests. Postman can create GET, PUT, POST, etc. requests complete with bodies. It can also be used to test endpoints automatically. This (`./restapi.postman_collection.json `) contains example requsts.
